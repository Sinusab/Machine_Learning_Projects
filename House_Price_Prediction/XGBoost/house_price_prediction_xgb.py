...
from xgboost import XGBRegressor  # Using XGBoost instead of RandomForest
...
# Numerical columns (Train): Fill with mean or specific values
...
# Create three versions of the dataset: mean, mode, and 2001
...
# Numerical columns (Test): Fill with mean or specific values
...
# Train and evaluate with XGBoost using cross-validation
regressor = XGBRegressor(random_state=0)  # XGBoost with default parameters and fixed seed
...
xg = XGBRegressor(random_state=0)  # XGBoost for validation
