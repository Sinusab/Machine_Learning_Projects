...
This project uses the XGBoost algorithm to predict house prices based on the "House Prices: Advanced Regression Techniques" dataset from Kaggle. The code includes data preprocessing, model training, evaluation using RMSLE and R^2, and visualization of results.
